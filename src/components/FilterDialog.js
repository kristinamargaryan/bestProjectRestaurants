          ...
          <div style={{ display: "flex", justifyContent: "space-evenly" }}>
            ...
            >
              <button style={{ display: "flex", alignItems: "center" }}>
                <WineBarIcon /> <div>Romantic</div>
              </button>
              <button style={{ display: "flex", alignItems: "center" }}>
                <BusinessCenterIcon /> <div>Busines</div>
              </button>
              <button style={{ display: "flex", alignItems: "center" }}>
                <GroupsIcon /> <div>Groups</div>
              </button>
            </div>
        ...
        <li>
          <div className="optionBar">
            ...
            <div style={{ display: "flex", justifyContent: "space-around" }}>
              ...
              >
                <button style={{ display: "flex", alignItems: "center" }}>
                  <EventSeatIcon /> <div>Reservation</div>
                </button>
                <button style={{ display: "flex", alignItems: "center" }}>
                  <TakeoutDiningIcon /> <div>TakeOut</div>
                </button>
                <button style={{ display: "flex", alignItems: "center" }}>
                  <CellWifiIcon />
                  <div>WiFi</div>
              ...
              >
                <button style={{ display: "flex", alignItems: "center" }}>
                  <DirectionsCarIcon /> <div>Parking</div>
                </button>
                <button style={{ display: "flex", alignItems: "center" }}>
                  <DeliveryDiningIcon /> <div>Delivery</div>
                </button>
                <button style={{ display: "flex", alignItems: "center" }}>
                  <AccessibleIcon /> <div>Whellchair</div>
                </button>
                <button style={{ display: "flex", alignItems: "center" }}>
                  <SportsBarIcon /> <div>Alcohol</div>
                </button>
                <button style={{ display: "flex", alignItems: "center" }}>
                  <NightlifeIcon />
                  <div>Atmosphere</div>
