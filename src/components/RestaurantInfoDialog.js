...
export default function RestaurantInfoDialog(props) {
    ...
    return (
        <div>
            ...
            >
                <DialogTitle id="scroll-dialog-title" style={{ fontSize: '25px', color: 'red', textAlign: 'center' }}>{data.restName}</DialogTitle>
                <DialogContent dividers={scroll === 'paper'}>
                    ...
                    >
                        ...
                        <div style={{ marginBottom: '10px' }}>
                            <div style={{ color: '#000', fontSize: '22px' }}><span style={{ color: 'green' }}>Moods: </span> {data.moods.join(', ')}</div>
                        ...
                        {!showMenu && <div style={{ display: 'flex',  width: '100%', flexWrap: 'wrap', justifyContent: 'center' }}>{data.photos.avatar.map(e => <img style={{ width: '160px', margin: '5px', height: '160px' }} src={e} />)}</div>}
                    </DialogContentText>
                </DialogContent>
                <DialogActions>
